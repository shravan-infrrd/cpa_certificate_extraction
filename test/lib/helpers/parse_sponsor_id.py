...
line_keywords = ['NASBA Sponsor registry number', 'NASBA Sponsor', 'NASBA -', 'National Registry of Sponsors If) Number -', 'Sponsor Id#', 'National Registry of CPE Sponsors ID#', 'National Registry of CPE Sponsors ID Number:', 'National Registry of CPE Sponsors 1D Number:', 'Natonal Registy', 'CPF Spongors ID Number', 'National Registry Sponsor No.', 'NASBA Sponsor ID', 'National Registry of CPE Sponsors ID:', 'National Registry Sponsor Number', 'Spenser License Numher', 'NASBA SPONSOR #', 'National Registry:', 'National Registry of CPE Sponsors ID Number', 'Natora Reg sty of CPE Socrac:s D8', 'CPE Credits earned:', 'NASBA Sponsor Registry Number', 'National Registry of CPE Sponsors 1D:', 'National Registry of CPE Sponsors [D:', 'Natona Reg stry of CPF Sponsors ID Number', 'Sponsors ID Number', 'Sponsors 1D Number:', 'Sponsors 1D Number', 'NASBA #', "NASBA's National Registry of CPE Sponsors - ID", 'Registry ID Nuanber:', 'NASBAsponsor#', 'NY Sponsor |O Number', 'CPE Sponsor ID #', 'NASBA Registry Provider #:', 'NASBA-', 'NASBA CPE SPONSOR REGISTRY NUMBER', 'NASBA SPONSOR', 'Nat cral Registry of CPE Sporsors ID#', 'CPE Sporsors ID#', 'Sponsor IO Number', 'NASBA National Registry of CPE Sponsors - Sponsor IO Number', 'NASBA National Registry of CPE Sponsors - Sponsor ID Number', 'Sponsor ID Number', 'Sponsor IO Number', 'ID Nnver', 'National Registry Sponsor Number:', 'FICPA Etrecs Provicer Number', 'Provider Number', 'Study C Numbe-', 'NASBASponsor Registry Number', 'QASSelf-Study:', 'NASBA:', 'Sponsor ID', 'NASBARegistry Sponsor Number', 'NASBA Registry ID:', 'Registry Identification Number:', 'NASBA ID', 'National Registry of CPE Sponsors #', 'NASBA Sponsor Number:']
